...
import RegisterForm from '../section/register-form';
          ...
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <div className="w-full md:w-1/2 pr-4 md:border-r mb-4 md:mb-0">
              ...
              <form>
                ...
                <button
                  type="submit"
                  className="bg-[#e60311] text-white rounded px-4 py-2 mt-2 hover:bg-[#e60311]"
                >
                  Ingrese
                </button>
              </form>
            ...
            <div className="w-full md:w-1/2 pl-0 md:pl-4">
              ...
              <button
                className="bg-[#e60311] text-white rounded px-4 py-2 hover:bg-[#e60311]"
